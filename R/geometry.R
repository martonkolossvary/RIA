...
#' RIA_image <- dichotomize(RIA_image, bins_in = c(4,8), equal_prob = TRUE, use_orig = TRUE)
#' RIA_image <- geometry(RIA_image, use_orig = FALSE, calc_sub = TRUE)
#'
#' #Use use_slot parameter to set which image to use
#' RIA_image <- geometry(RIA_image, use_orig = FALSE, calc_sub = TRUE, use_slot = "dichotomized$ep_4")
#' 
#' #Batch calculation of geometry-based statistics on all dichotomized images and subcomponents
#' RIA_image <- geometry(RIA_image, use_type = "dichotomized", calc_sub = TRUE)
#' }
